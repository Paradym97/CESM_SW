...
!if(masterproc)then
!write(*,*)"cam_read_restart 003"
!end if
  call PIO_SetErrorHandling(File, PIO_INTERNAL_ERROR)

!if(masterproc)then
!write(*,*)"cam_read_restart 004"
!end if
...
!if(masterproc)then
!write(*,*)"cam_read_restart 006"
!end if
  call read_restart_dynamics(File, dyn_in, dyn_out, NLFileName)   

!if(masterproc)then
!write(*,*)"cam_read_restart 007"
!end if
  call initcom ()
!if(masterproc)then
!write(*,*)"cam_read_restart 008"
!end if
  call phys_grid_init

!if(masterproc)then
!write(*,*)"cam_read_restart 009"
!end if
  call hub2atm_alloc(cam_in)
!if(masterproc)then
!write(*,*)"cam_read_restart 010"
!end if
  call atm2hub_alloc(cam_out)

!if(masterproc)then
!write(*,*)"cam_read_restart 011"
!end if

  ! Initialize physics grid reference pressures (needed by initialize_radbuffer)
!if(masterproc)then
!write(*,*)"cam_read_restart 012"
!end if
   call ref_pres_init()

!if(masterproc)then
!write(*,*)"cam_read_restart 013"
!end if
   call read_restart_physics(File, cam_in, cam_out, pbuf2d)

!if(masterproc)then
!write(*,*)"cam_read_restart 014"
!end if
...
!if(masterproc)then
!write(*,*)"cam_read_restart 016"
!end if
   call chem_surfvals_init()
!if(masterproc)then
!write(*,*)"cam_read_restart 017"
!end if
   call clean_iodesc_list()
!if(masterproc)then
!write(*,*)"cam_read_restart 018"
!end if
