...
!BOC
   ...
   !*** ccsm
! public set by zengyh 2019-02-14:
   type (tavg_field_desc_ccsm), dimension(max_avail_tavg_fields), public :: &
      avail_tavg_fields
...
! public set by zengyh 2019-02-14:
   real (rtavg), dimension(:,:,:,:), allocatable, public :: &
...
!	     write(stdout,*) "num_avail_tavg_fields=  ",num_avail_tavg_fields
!     endif
     do nfield = 1,num_avail_tavg_fields  ! check all available fields

        loc = avail_tavg_fields(nfield)%buf_loc
        
!     if (my_task.eq.master_task) write(stdout,*) "nfield:  ",nfield
